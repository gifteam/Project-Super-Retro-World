...
struct MAP{
    std::map <std::string, std::string> STYLE_NAME;
    std::map <std::string, std::vector<std::string> > BACK_STYLE;
    std::map <std::string, std::string> FRONT_STYLE;
    std::map <std::string, std::string> TILE_STYLE;
